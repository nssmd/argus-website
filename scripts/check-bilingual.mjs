...
for (const page of ["projects/mathematics/index.html", "zh/projects/mathematics/index.html"]) {
  ...
  assert(html.includes("Nine mathematical result packages") || html.includes("九个数学成果包"), `${page} lacks the current mathematics result count`);
  assert(html.includes("45 public artifacts") || html.includes("45 个公开产物"), `${page} lacks the current evidence count`);
